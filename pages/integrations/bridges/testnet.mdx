...
<Callout type="info" emoji="ℹ️" title="Tokens">
  If you want to learn more about supported tokens or wish to add your token to
  this list, go to the [Tokens](/tokens) page.
</Callout>

## FAQ

<FAQBox title="Can I transfer tokens through the Superbridge UI?">Yes</FAQBox>
