...
<FAQBox title="Can I transfer tokens through the Superseed Bridge UI?">
  ...
  Yes, if you want to learn more about supported tokens, go to the [Tokens](https://github.com/superseed-xyz/docs/blob/ff8abe1dae3ae81d52dc4ac6492b12dddb2f90fd/pages/tokens.mdx#L4) page.

</FAQBox>

<FAQBox title="What if I have a question, issue or problem?">

  The Superseed [Discord](https://discord.gg/vjDDB5S4BN) is open for assistance and support! You can create a support ticket in the [#tickets channel](https://discord.com/channels/1199722631893631096/1210483734659473408)
